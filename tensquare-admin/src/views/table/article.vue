...
<el-input v-model="searchMap.createtime" placeholder="发表日期" type="date"></el-input></el-form-item>
          <el-form-item label="修改日期">
<el-input v-model="searchMap.updatetime" placeholder="修改日期" type="date"></el-input></el-form-item>
...
<el-input v-model="searchMap.type" placeholder="类型"></el-input></el-form-item>
  ...
  <el-dialog title="编辑" :visible.sync="dialogFormVisible">
    <el-form label-width="80px">
        ...
        <el-form-item label="文章正文"><el-input v-model="pojo.content" type="textarea" rows="5"></el-input></el-form-item>
        <!-- <div v-html='pojo.content'></div> -->
        <el-form-item label="文章封面"><el-input v-model="pojo.image"></el-input></el-form-item>
        <el-form-item label="发表日期"><el-input v-model="pojo.createtime" type="date"></el-input></el-form-item>
        <el-form-item label="修改日期"><el-input v-model="pojo.updatetime" type="date"></el-input></el-form-item>
