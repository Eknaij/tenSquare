...
<el-input v-model="searchMap.createtime" placeholder="申请日期" type="date"></el-input></el-form-item>
          <el-form-item label="审核日期">
<el-input v-model="searchMap.checktime" placeholder="审核日期" type="date"></el-input></el-form-item>
...
<el-input v-model="searchMap.state" placeholder="状态"></el-input></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
          ...
          <el-table-column prop="name" label="专栏名称" width="150"></el-table-column>
          <el-table-column prop="summary" label="专栏简介" width="300"></el-table-column>
    ...
    <el-form label-width="80px">
        ...
        <el-form-item label="申请日期"><el-input v-model="pojo.createtime" type="date"></el-input></el-form-item>
        <el-form-item label="审核日期"><el-input v-model="pojo.checktime" type="date"></el-input></el-form-item>
